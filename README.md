...
> **112 个绘图/分析引擎 + 188 个 RPC 数据工具 + 39 个命令行工具 + 任意引擎反射**，全部实测出图。
> 2026-08-29 达成 112 引擎里程碑（含 dualsyn 旧框架保存破解 + eFP 热图/全管线 miRNA/双向 BLAST 等），47 个 Java 桥，150+ 命令。
...
|:------|:-----------|:------|
| 🎨 **绘图引擎** | 112 个（基因结构/Motif/热图/树/共线性/韦恩/ChIP-seq/柱图/环形图/标记设计/eFP 等） | `tbtools <plotName>` |
