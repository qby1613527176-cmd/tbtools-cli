...
> **118 个绘图/分析引擎 + 188 个 RPC 数据工具 + 77 个命令行工具 + 任意引擎反射**，全部实测出图。
...
| 🛠️ **命令行工具** | 77 个（extractFasta/statFasta/rpkmCal/tpmCalc/mimicVqsr 等） | `tbtools tool <name>` |
...
| 🛠️ **命令行工具** | 77 个（extractFasta/statFasta/rpkmCal/tpmCalc/mimicVqsr 等） | `tbtools tool <名称>` |
